...
// Указываем родительский элемент для модального окна для доступности
          ...
          <table className="w-full border-collapse border border-gray-600">
            <thead>
              <tr className="bg-gray-800">
                <th className="border border-gray-600 px-4 py-2">Отклонение (мс)</th>
                <th className="border border-gray-600 px-4 py-2">Скидка (%)</th>
              </tr>
            </thead>
            <tbody>
              <tr>
